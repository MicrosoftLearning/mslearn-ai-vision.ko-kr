...
3. Video Analyzer에서 **업로드** 옵션을 선택합니다. 그런 다음 **URL 입력** 옵션을 선택하고 `https://aka.ms/responsible-ai-video`을(를) 입력하고 **추가**를 클릭합니다. 기본 이름을 **책임 있는 AI**로 변경하고 기본 설정을 검토한 후 확인란을 선택하여 Microsoft의 얼굴 인식 정책 준수 여부를 확인한 다음 파일을 업로드합니다.
